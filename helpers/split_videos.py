...
videos_folder = r'Path_of_videos_folder' # where the videos are stored

destination_path = r'Path_of_destination_folder' # where the images and labels will be saved
